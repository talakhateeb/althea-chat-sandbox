...
export default function Home() {
  ...
  async function send() {
    ...
    try {
      ...
      if (!res.ok) {
        setMsgs(h => [...h, { role: "assistant", content: `Error: ${data.error || "Something went wrong"}` }]);
      } else {
      ...
      <header style={{
        ...
        <div style={{ maxWidth: 720, margin: "0 auto" }}>
          ...
          <p style={{ margin: "4px 0 0", fontSize: 14, color: "#b8a8e8" }}>
            What&apos;s on your mind? This is a gentle space for reflection, not a substitute for professional care.
          </p>
        </div>
      </header>
