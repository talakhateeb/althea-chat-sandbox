...
api.openai.com
", { method: "POST", headers: { "Content-Type": "application/json", Authorization: Bearer ${process.env.OPENAI_API_KEY}, }, body: JSON.stringify({ model: "gpt-4o-mini", messages: [ { role: "system", content: "You are Althea’s guide: warm, calm, and supportive, but not a replacement for professional mental health care." }, { role: "user", content: "Hello" } ], temperature: 0.6 }), });
